...
export default function AdminDashboardPage() {
  ...
  async function saveRelease() {
    try {
      const saved = selectedReleaseId === 'new'
        ? await api.createRelease(releaseForm, token)
        : await api.updateRelease(selectedReleaseId, releaseForm, token);
      ...
      flash(selectedReleaseId === 'new' ? '发布项已创建。' : '发布项已保存。');
    } catch (error) {
      flash(error.message);
    }
  }
          ...
          {activeTab === 'releases' && (
            <div className="admin-stack">
              <section className="admin-surface">
                ...
                <button className="admin-primary" type="button" onClick={saveSiteSettings}>
                  <Save size={16} />
                  保存首页与导航
                </button>
              </section>
                ...
                <div className="release-manager-grid">
                  ...
                  <div className="release-editor-panel">
                    ...
                    <div className="admin-actions">
                      <button className="admin-primary" type="button" onClick={saveRelease}>
                        <Save size={16} />
                        保存发布项
                      </button>
                      {selectedReleaseId !== 'new' && (
