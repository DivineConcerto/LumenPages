...
import { ArrowUpRight, Github, Linkedin, Mail, Search, ShoppingBag, Sparkles, Twitter } from 'lucide-react';
...
const defaultAtelierNav = Array.from({ length: 10 }, (_, index) => ({
  label: `测试${index + 1}`,
...
function normalizeNavItems(site, isAtelier) {
  ...
  return normalized.length ? normalized : defaultAtelierNav;
}
